...
public interface MessagePromptOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ai.generativelanguage.v1beta2.MessagePrompt)
   ...
   */
  java.util.List<com.google.ai.generativelanguage.v1beta2.Example> 
      getExamplesList();
  /**
   * <pre>
   * Optional. Examples of what the model should generate.
   ...
   * <code>repeated .google.ai.generativelanguage.v1beta2.Example examples = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ai.generativelanguage.v1beta2.Example getExamples(int index);
  /**
   * <pre>
   * Optional. Examples of what the model should generate.
   * This includes both user input and the response that the model should
   ...
   * <code>repeated .google.ai.generativelanguage.v1beta2.Example examples = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.ai.generativelanguage.v1beta2.ExampleOrBuilder> 
   ...
   * <code>repeated .google.ai.generativelanguage.v1beta2.Example examples = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ai.generativelanguage.v1beta2.ExampleOrBuilder getExamplesOrBuilder(
      int index);
